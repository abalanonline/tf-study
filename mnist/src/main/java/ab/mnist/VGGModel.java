 ...
 */
public class VGGModel implements NnModel, AutoCloseable {
    ...
    public static void main(String[] args) {
        ...
        try (VGGModel vggModel = new VGGModel()) {
            ...
            vggModel.train(dataset, Common.TRAIN_BATCH_SIZE, Common.TRAIN_BATCH_SIZE);

            logger.info("Model evaluation.");
            vggModel.test(dataset, Common.TEST_BATCH_SIZE);
        }
    }
